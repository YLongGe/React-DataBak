...
class ExportData extends Component{
    ...
    render(){
        ...
        return(
            <div>
                <div>
                <form action="http://192.168.18.127:8080/hello" method="post" >
                    ...
                    <label className="radio-inline">
                         <input type="radio" name="dbtype"  value="SqlServer"/> SqlServer
                    </label>
                    </div>
                    
                    {/* 用户名，密码 */}
                    <div className="form-group">
                        <label htmlFor="inputEmail3" className="control-label">用户名</label>
                        <input className="form-control" name="dbname" placeholder="请输入用户名" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="inputPassword3" className="control-label">密码</label>
                        <input type="password" className="form-control" name="dbpassword" placeholder="请输入密码"/>
                    </div>
